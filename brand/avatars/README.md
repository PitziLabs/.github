...
Canonical GitHub avatar marks for the Lentago Labs identity. Both are the brand
...
|------|------|---------|---------|
| `pl-navy.svg` / `pl-navy-512.png` | `<pl:>` | rounded | **Org** avatar — `github.com/lentago` |
...
- Brand contract: `lentago/pitzilabs-dev` → `BRAND.md` (the chip spec lives under
